...
const fr: Dict = {
  ...
  printer_transport_usb: 'USB (Linux / macOS)',
  printer_transport_cups: 'File d’impression CUPS',
  printer_transport_windows: 'Imprimante partagée Windows',
  printer_target_usb: 'Port USB (ex. /dev/usb/lp0)',
  printer_target_cups: 'Nom de la file CUPS (ex. POS80)',
  printer_target_windows: 'Partage Windows (ex. \\\\localhost\\POS80)',
...
const ma: Dict = {
  ...
  printer_transport_windows: 'طابعة مشاركة ف Windows',
  printer_target_usb: 'البور USB (مثلا /dev/usb/lp0)',
  printer_target_cups: 'سمية الفيل CUPS (مثلا POS80)',
  printer_target_windows: 'المشاركة ديال Windows (مثلا \\\\localhost\\POS80)',
