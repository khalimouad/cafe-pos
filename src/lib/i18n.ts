...
const fr: Dict = {
  ...
  printer_sub_share: 'Le ticket part sur l’imprimante partagée par Windows, sans boîte de dialogue. L’agent (dossier printer-agent) doit tourner sur le poste.',
  printer_share: 'Imprimante partagée Windows',
  printer_agent_url: 'Adresse de l’agent (auto)',
  printer_agent_hint: 'Laissez « auto » si le POS est ouvert depuis l’agent : utilisé actuellement → {url}',
  ...
  printer_windows_list: 'Imprimantes du poste : {list}',
  ...
  printer_no_agent: 'Agent d’impression injoignable ({detail}). Vérifiez qu’il tourne sur le poste, puis ouvrez {url} dans un navigateur : du texte doit s’afficher. Sinon, pare-feu ou mauvaise adresse.',
  printer_refused: 'L’agent a bien reçu le ticket mais l’impression a échoué : {detail}',
  printer_mixed_content: 'Cette page est en HTTPS et l’agent en HTTP ({url}) : le navigateur bloque l’appel. Ouvrez le POS depuis l’agent lui-même (http://ip-du-poste:7777).',
  ...
  cancel_title: 'Annuler la commande n° {n} ?',
  cancel_sub: 'Réservé au responsable : saisissez son code à 4 chiffres. La commande reste dans l’historique, marquée annulée, et sort des totaux — pensez à ressortir {amount} du tiroir.',
  cancel_confirm: 'Confirmer l’annulation',
  cancelled_badge: 'Annulée',
  cancelled_by: 'Annulée par {name}',
  toast_cancelled: 'Commande n° {n} annulée par {name}',
  stat_cancelled: 'Annulations',
  tk_cancelled: 'Annulations',
...
const ma: Dict = {
  ...
  printer_sub_share: 'التيكي كيمشي ديريكت للطابعة المشاركة ف Windows، بلا ما يطلع شي بوكس. خاص البرنامج (printer-agent) يكون خدام ف البوسط.',
  printer_share: 'الطابعة المشاركة ف Windows',
  printer_agent_url: 'العنوان ديال البرنامج (auto)',
  printer_agent_hint: 'خلّي « auto » إلا حليتي POS من البرنامج : دابا كنستعملو → {url}',
  ...
  printer_no_agent: 'البرنامج ديال الطباعة ماوصلش ({detail}). شوف واش خدام ف البوسط، من بعد حل {url} ف النافيݣاتور : خاص يبان شي نص. إلا لا، يمكن الپاروفو ولا العنوان غالط.',
  printer_refused: 'البرنامج توصّل بالتيكي ولكن الطباعة ماتمّاتش : {detail}',
  printer_mixed_content: 'هاد الصفحة ب HTTPS و البرنامج ب HTTP ({url}) : النافيݣاتور كيبلوكي. حل POS مباشرة من البرنامج (http://ip-ديال-البوسط:7777).',
  ...
  cancel_order: 'صيفط للإلغاء',
  cancel_title: 'باغي تلغي الكوموند رقم {n} ؟',
  cancel_sub: 'غير المسؤول اللي كيلغي : دخّل الكود ديالو ب 4 أرقام. الكوموند غادي تبقى ف التاريخ، متسجلة ملغية، وتخرج من الحساب — ماتنساش تخرج {amount} من التيروار.',
  cancel_confirm: 'أكّد الإلغاء',
  cancelled_badge: 'ملغية',
  cancelled_by: 'لغاها {name}',
  toast_cancelled: 'الكوموند رقم {n} تلغات من طرف {name}',
  stat_cancelled: 'الإلغاءات',
  tk_cancelled: 'الإلغاءات',
