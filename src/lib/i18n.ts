...
const fr: Dict = {
  ...
  printer_sub: 'Impression directe, sans boîte de dialogue, via l’agent installé sur le poste (dossier printer-agent).',
  ...
  printer_ok: 'Imprimante joignable sur {ip}:{port}.',
...
const ma: Dict = {
  ...
  printer_sub: 'الطباعة ديريكت بلا ما يطلع شي بوكس، عن طريق البرنامج الصغير اللي ف البوسط (printer-agent).',
  ...
  printer_ok: 'الطابعة واصلة ف {ip}:{port}.',
